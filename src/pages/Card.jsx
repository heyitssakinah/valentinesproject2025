    ...
    <div className="font-serif bg-gradient-to-b to-darkred via-30% via-barnred from-red-950 w-screen h-screen">
      <div className="flex md:flex-row flex-col items-center justify-center h-screen w-screen">
        ...
        >
          ...
          <button
            className="inline-block rounded-full border-2 border-myred text-myred focus:border-myred focus:text-myred active:border-rose-800 active:text-rose-800 dark:border-rose-300 dark:text-rose-300 dark:hover:hover:bg-rose-300 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out focus:outline-none focus:ring-0"
            type="button"
          >
            <div
              role="status"
